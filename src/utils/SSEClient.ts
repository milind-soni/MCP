...
// import { JSONRPCMessage, JSONRPCMessageSchema }
        ...
        try {
          ...
          if (messageEvent.data.startsWith("/")) {
            ...
            this._endpoint = new URL(
              `${this._url.protocol}//${this._url.host}${chatPath}${messageEvent.data}`
            );
          } else {
            // If server sends relative path, use URL constructor
            this._endpoint = new URL(messageEvent.data, this._url);
          }
